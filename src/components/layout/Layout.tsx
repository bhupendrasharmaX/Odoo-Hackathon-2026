  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <footer className="border-t border-outline-variant/30 bg-surface-container-lowest py-4 px-6 flex flex-col sm:flex-row justify-between items-center text-xs text-on-surface-variant gap-2 shrink-0">
